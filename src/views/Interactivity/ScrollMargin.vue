...
<template>
  <header-h1>Scroll Margin</header-h1>
  <!-- 用于控制捕捉容器中项目周围滚动偏移的实用程序 -->
  <paragraph-h2>设置滚动边距</paragraph-h2>
  <!--
  使用 scroll-mt-*、scroll-mr-*、scroll-mb-* 和 scroll-ml-*
  实用程序设置捕捉容器内项目周围的滚动偏移
  -->
  <div
  ...
  >
    ...
    <div class="relative overflow-auto rounded-xl">
      <div class="flex w-full snap-x gap-12 overflow-x-auto py-14">
        <div
          class="relative shrink-0 snap-start scroll-ml-6 first:pl-6 last:pr-[calc(100%-21.5rem)]"
        >
          <div class="bg-stripes-pink absolute bottom-0 left-0 top-0 w-6"></div>
          <img
            class="relative h-40 w-80 shrink-0 rounded-lg bg-white shadow-xl"
        ...
        <div
          class="relative shrink-0 snap-start scroll-ml-6 first:pl-6 last:pr-[calc(100%-21.5rem)]"
        >
          <div class="bg-stripes-pink absolute -left-6 bottom-0 top-0 w-6"></div>
          <img
            class="relative h-40 w-80 shrink-0 rounded-lg bg-white shadow-xl"
