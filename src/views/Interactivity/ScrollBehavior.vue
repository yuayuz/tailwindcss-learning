...
<template>
  <header-h1>Scroll Behavior</header-h1>
  <!-- 用于控制元素滚动行为的实用程序 -->
  <paragraph-h2>添加平滑滚动</paragraph-h2>
  <!-- 使用该 scroll-smooth 实用程序可实现元素内的平滑滚动 -->
  <div
  ...
  >
    ...
    <div class="relative overflow-auto rounded-xl">
      <div class="flex w-full snap-x gap-12 overflow-x-auto py-14">
        <div class="relative shrink-0 snap-start first:pl-6 last:pr-[calc(100%-21.5rem)]">
